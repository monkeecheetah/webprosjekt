$(document).ready(function(){
      ...
      jarallax.addAnimation(".bak1",[{progress:"89%", top:"600%"}, {progress:"100%", top:"600%"}]);
     /* jarallax.addAnimation(".bak1",[{progress:"97%", top:"600%"}, {progress:"100%", top:"750%"}]);*/
      ...
      jarallax.addAnimation(".bak2",[{progress:"89%", top:"720%"}, {progress:"100%", top:"720%"}]);
      ...
      jarallax.addAnimation(".bak3",[{progress:"89%", top:"840%"}, {progress:"100%", top:"840%"}]);
     /* jarallax.addAnimation(".bak3",[{progress:"97%", top:"840%"}, {progress:"100%", top:"990%"}]);*/
      ...
      jarallax.addAnimation(".bak4",[{progress:"89%", top:"960%"}, {progress:"100%", top:"960%"}]);
      ...
      jarallax.addAnimation(".bak5",[{progress:"89%", top:"1080%"}, {progress:"100%", top:"1080%"}]);
