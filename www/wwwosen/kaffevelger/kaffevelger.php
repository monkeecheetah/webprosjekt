...
<html>
	...
	<body onload="init()">
		...
		<form id="kaffevelger">
			...
			<input type="radio" name="tid" id="tid1" value="t1">
			<label for="tid1">Dårlig tid</label>
			<input type="radio" name="tid" id="tid2" value="t2" checked>
			...
			<input type="radio" name="okonomi" id="oko1" value="o1">			
			<label for="oko1">Tynn</label>
			<input type="radio" name="okonomi" id="oko2" value="o2" checked>
			...
			<input type="radio" name="egeninnsats" id="egen1" value="e1">			
			<label for="egen1">Jeg vil gjøre minst mulig for kaffen min</label>
			<input type="radio" name="egeninnsats" id="egen2" value="e2" checked>
			<label for="egen2">Jeg kan løfte en finger for kaffen</label>
			<input type="radio" name="egeninnsats" id="egen3" value="e3">
