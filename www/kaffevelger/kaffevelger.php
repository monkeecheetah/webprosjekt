...
<html>
	...
	<body onload="init()">
		...
		<form id="kaffevelger">
			...
			<input type="radio" name="tid" id="tid2" value="2.0" checked>
			...
			<input type="radio" name="okonomi" id="oko2" value="2.0" checked>
			...
			<input type="radio" name="egeninnsats" id="egen2" value="2.0" checked>
