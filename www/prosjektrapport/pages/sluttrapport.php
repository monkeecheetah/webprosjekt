...
<ul>
	...
	<li><a href="#ambisjonsnivå">Ambisjonsnivå</a></li>
</ul>
...
<ul>
	...
	<li><a href="#målgruppe">Målgruppe</a></li>
	<li><a href="#arbeidsmetode">Arbeidsmetode</a></li>
...
<ul>
	<li><a href="#stegforsteg">Steg for steg</a></li>
	<li><a href="#teknologiskutvikling">Teknologisk utvikling</a></li>
	<li><a href="#tegning">Produksjon av egne bilder</a></li>
</ul>
...
<ul>
	<li><a href="#presentasjon">Presentasjon av nettside</a></li>
	<li><a href="#scroll">Scrollefunksjon</a></li>
	<li><a href="#kaffevelger">Kaffevelger</a></li>
	<li><a href="#design">Design</a></li>
	<li><a href="#bilder">Bilder</a></li>
	<li><a href="#responsivt">Responsivt design</a></li>
