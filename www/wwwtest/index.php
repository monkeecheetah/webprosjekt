...
<html>
	...
	<body>
		...
		<article id ="content">
			...
			<div id="svar">
				<p>
					Kaffe er et frø i en frukt, eller “a cherry”<br>
					Som vokser på kaffetrærne langs fjellsiden eller i høyden<br>
					Arabicatrærene vokser i fuktig klima, høyt oppe mens de<br>
					hardføre robustatrærene vokser lavere og tåler mer</p>
					
				<p> Fruktene høstes, frøene tas ut, tørkes og sendes i 60kg sekker verden rundt<br></p>

				<p> Det er den 2. mest (lovlige) omsatte varen i verden etter olje<br></p>
			...
			<div>
				<p>
					Har du opplevd å få fine mønster i kaffen din?<br>
					Har du opplevd å få en figur i kaffen din?<br><br>

					Kaffe - kaffe. Smak på ordet<br>
					Hvor kommer det fra?<br>
					Første gang dokumentert er fra 1598 på italiensk, caffe<br>
					Som igjen er fra tyrkisk kahve<br>
					Som igjen er avledet fra det arabiske ordet qahwah (kaffe). <br>
					Det siste skal etter sigende bety vin, <br>
					Mer sannsynlig har det sin opprinnelse fra den etiopiske regionen Kaffa, et tradisjonelt område for kaffeproduksjon. <br>
					Kaffe er forøvrig kalt buno i Etiopia<br><br>

					Kaffe har også påvirket kultur<br>
				</p>
			</div>
		</article>
