...
<html>
	...
	<body>
		...
		<article id ="content">
			...
			Har du opplevd å få fine mønster i kaffen din?
			Har du opplevd å få en figur i kaffen din?

			Kaffe - kaffe. Smak på ordet
			Hvor kommer det fra?
			Første gang dokumentert er fra 1598 på italiensk, caffe
			Som igjen er fra tyrkisk kahve
			Som igjen er avledet fra det arabiske ordet qahwah (kaffe). 
			Det siste skal etter sigende bety vin, 
			Mer sannsynlig har det sin opprinnelse fra den etiopiske regionen Kaffa, et tradisjonelt område for kaffeproduksjon. 
			Kaffe er forøvrig kalt buno i Etiopia

			Kaffe har også påvirket kultur
		</article>
